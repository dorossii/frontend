...
class _FriendPictureView extends State<FriendPictureView> {
  ...
  Widget build(BuildContext context) {
    ...
    return TakePictureDesign(
      ...
      pageType: "friend",
      imagePath: 'https://mock-dorossii.mattuu.com/app/user/task/${pendingData!.imageId}/image',
      // imagePath: 'https://mock-dorossii.mattuu.com/app/user/task/image?imageId=img-aaa',
    );
